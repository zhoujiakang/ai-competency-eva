 ...
 */
public class Assessment { @TableId(type=IdType.AUTO) Long id; Long taskId; Long classId; Long studentUserId; String dimensions; String assessmentPoints; Integer questionCount=0; String status="in_progress"; Instant startedAt=Instant.now(); Instant completedAt; Double totalScore; Double averageScore; String abilityLevel; String advice; Instant createdAt=Instant.now(); Instant updatedAt=Instant.now(); public Assessment(Long task,Long clazz,Long student){taskId=task;classId=clazz;studentUserId=student;} public Assessment(Long clazz,Long student){classId=clazz;studentUserId=student;} }
